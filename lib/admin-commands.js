...
export function setupAdminCommands(bot) {
  // /addcashier, /removecashier, /add_category, /add_item,
  // /add_topping, /add_group, /assign_group_to_item, /assign_topping_to_group
  // are command-entry points that feed into the same adminFlowState flows
  // handled in the bot.on('text') handler in webhook.js.
